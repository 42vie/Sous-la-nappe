...
export const ENDING_SUMMARIES: Record<EndingId, EndingSummary> = {
  ...
  F_YANIS_PART: {
    ...
    detail: "Sur la terrasse, avant que le service ne commence vraiment, Yanis propose à Lucas qu'ils partent tous les deux — une intuition qu'il n'aurait pas su justifier sur le moment, un malaise diffus qu'il attribue à la fatigue ou à trop de vin. Il ne saura jamais avec certitude ce qu'il a évité en insistant. Noé survit, comme dans la plupart des versions de cette nuit, mais Yanis n'est plus vraiment là pour la suite — et c'est peut-être la chose la plus lucide qu'il ait faite de toute la soirée, sans jamais comprendre pourquoi.",
    lastLine: "Il n'a jamais su ce qu'il avait évité. Il a juste eu raison, une fois, sans preuve.",
  },
  F14: {
    title: 'Le silence de groupe',
    short: 'Noé survit. Rien ne s\'est jamais vraiment mis en mouvement cette nuit-là.',
