...
/**
 * Page dédiée à la sélection du prochain point de vue — avant, la grille
 * était affichée sous le carrousel de contexte de /chapter, ce qui forçait
 * à scroller pour l'atteindre. Une page à part rend le choix immédiat.
 */
export default function ChapterCharacterSelectPage() {
